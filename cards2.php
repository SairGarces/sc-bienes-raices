<div class="contenedor">
    <div class="cartas_cards">
        <div>
            ...
            <div class="card">
                <img class="image_propie" src="assets/img/3.jpg" alt="Imagen de la propiedad">
                <h3 class="title_card">Casa en el campo</h3>
                <p class="description">Casa en el campo alejada de el bullicion de la sociedad</p>
        ...
        <div>
            <div class="card">
                <img class="image_propie" src="assets/img/4.jpg" alt="Imagen de la propiedad">
                <h3 class="title_card">Casa en el campo</h3>
                <p class="description">Casa en el campo alejada de el bullicion de la sociedad</p>
            ...
            <div class="card">
                <img class="image_propie" src="assets/img/5.jpg" alt="Imagen de la propiedad">
                <h3 class="title_card">Casa en el campo</h3>
                <p class="description">Casa en el campo alejada de el bullicion de la sociedad</p>
            ...
            <div class="card">
                <img class="image_propie" src="assets/img/6.jpg" alt="Imagen de la propiedad">
                <h3 class="title_card">Casa en el campo</h3>
                <p class="description">Casa en el campo alejada de el bullicion de la sociedad</p>
